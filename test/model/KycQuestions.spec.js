...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YlThirdPartyOnboardingApiClient.KycQuestions();
  });
  ...
  describe('KycQuestions', function() {
    it('should create an instance of KycQuestions', function() {
      // uncomment below and update the code to test KycQuestions
      //var instane = new YlThirdPartyOnboardingApiClient.KycQuestions();
      //expect(instance).to.be.a(YlThirdPartyOnboardingApiClient.KycQuestions);
    });
