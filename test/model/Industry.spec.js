...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YlThirdPartyOnboardingApiClient.Industry();
  });
  ...
  describe('Industry', function() {
    it('should create an instance of Industry', function() {
      ...
      //var instane = new YlThirdPartyOnboardingApiClient.Industry();
      //expect(instance).to.be.a(YlThirdPartyOnboardingApiClient.Industry);
    });
