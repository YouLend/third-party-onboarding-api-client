...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YlThirdPartyOnboardingApiClient.SignificantPersonV2();
  });
  ...
  describe('SignificantPersonV2', function() {
    it('should create an instance of SignificantPersonV2', function() {
      // uncomment below and update the code to test SignificantPersonV2
      //var instane = new YlThirdPartyOnboardingApiClient.SignificantPersonV2();
      //expect(instance).to.be.a(YlThirdPartyOnboardingApiClient.SignificantPersonV2);
    });
