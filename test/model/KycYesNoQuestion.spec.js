...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YlThirdPartyOnboardingApiClient.KycYesNoQuestion();
  });
  ...
  describe('KycYesNoQuestion', function() {
    it('should create an instance of KycYesNoQuestion', function() {
      // uncomment below and update the code to test KycYesNoQuestion
      //var instane = new YlThirdPartyOnboardingApiClient.KycYesNoQuestion();
      //expect(instance).to.be.a(YlThirdPartyOnboardingApiClient.KycYesNoQuestion);
    });
