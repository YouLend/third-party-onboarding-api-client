...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YlThirdPartyOnboardingApiClient.KycDocumentModel();
  });
  ...
  describe('KycDocumentModel', function() {
    it('should create an instance of KycDocumentModel', function() {
      // uncomment below and update the code to test KycDocumentModel
      //var instane = new YlThirdPartyOnboardingApiClient.KycDocumentModel();
      //expect(instance).to.be.a(YlThirdPartyOnboardingApiClient.KycDocumentModel);
    });
    ...
    it('should have the property kycDocumentType (base name: "kycDocumentType")', function() {
      // uncomment below and update the code to test the property kycDocumentType
      //var instane = new YlThirdPartyOnboardingApiClient.KycDocumentModel();
      //expect(instance).to.be();
    });
