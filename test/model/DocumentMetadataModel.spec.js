...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YlThirdPartyOnboardingApiClient.DocumentMetadataModel();
  });
  ...
  describe('DocumentMetadataModel', function() {
    it('should create an instance of DocumentMetadataModel', function() {
      ...
      //var instane = new YlThirdPartyOnboardingApiClient.DocumentMetadataModel();
      //expect(instance).to.be.a(YlThirdPartyOnboardingApiClient.DocumentMetadataModel);
    });
