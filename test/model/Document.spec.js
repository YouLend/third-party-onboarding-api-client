...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YlThirdPartyOnboardingApiClient.Document();
  });
  ...
  describe('Document', function() {
    it('should create an instance of Document', function() {
      ...
      //var instane = new YlThirdPartyOnboardingApiClient.Document();
      //expect(instance).to.be.a(YlThirdPartyOnboardingApiClient.Document);
    });
    ...
    it('should have the property dateTimeUploaded (base name: "dateTimeUploaded")', function() {
      // uncomment below and update the code to test the property dateTimeUploaded
      //var instane = new YlThirdPartyOnboardingApiClient.Document();
      //expect(instance).to.be();
    });
